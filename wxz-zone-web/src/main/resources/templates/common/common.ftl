...
<div class="blogerinfo shadow">
    ...
    <div class="blogerinfo-contact">
        ...
        <a target="_blank" title="massage专用" href="https://www.zhihu.com/people/wangxianzhi1211/activities"><i
                class="fa fa-openid fa-lg"></i> massage专用</a>

    </div>
    <div class="blogerinfo-contact">
        <a target="_blank" title="massage简介"
           href="http://tieba.baidu.com/home/main?un=%E9%9B%B7%E7%A5%AD%E7%9A%84%E5%AD%98%E5%9C%A8&fr=home"><i
                class=" fa fa-twitch fa-lg"></i> massage简介</a>
