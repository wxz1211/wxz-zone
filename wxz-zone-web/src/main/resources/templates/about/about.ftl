                        ...
                        <div class="layui-tab-item">
                            <div class="aboutinfo">
                                <div class="aboutinfo-figure">
                                    <img src="${cxt.contextPath}/images/Logo_100.png" alt="不落阁" />
                                </div>
                                ...
                                <div class="aboutinfo-contact">
                                    <a target="_blank" title="网站首页" href="../home/home.ftl"><i class="fa fa-home fa-2x" style="font-size:2.5em;position:relative;top:3px"></i></a>
                                    <a target="_blank" title="文章专栏" href="../article/article.ftl"><i class="fa fa-file-text fa-2x"></i></a>
                                    <a target="_blank" title="资源分享" href="../resource/resource.ftl"><i class="fa fa-tags fa-2x"></i></a>
                                    <a target="_blank" title="点点滴滴" href="../timeline/timeline.ftl"><i class="fa fa-hourglass-half fa-2x"></i></a>
                                </div>
                                            ...
                                            <ul class="blog-comment">
                                                <li>
                                                    <div class="comment-parent">
                                                        <img src="${cxt.contextPath}/images/Logo_40.png" alt="不落阁" />
                                                        <div class="info">
